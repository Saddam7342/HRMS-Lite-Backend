...
public interface IUserRepository : IGenericRepository<AppUser>
{
    ...
    Task<AppUser?> GetByEmailAndTenantAsync(string email, Guid organizationId, CancellationToken ct = default);
    ...
    Task<bool> EmailExistsAsync(string email, Guid organizationId, CancellationToken ct = default);
}
